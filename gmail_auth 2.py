...
def main():
    ...
    try:
        ...
        db = mysql.connector.connect(host="localhost",user="root",password="Krishna3101",database="emailDB",auth_plugin='mysql_native_password',charset='utf8mb4',collation='utf8mb4_unicode_ci')
        cur = db.cursor()
        cnt=1
        l=[]
        for msg in messages:
